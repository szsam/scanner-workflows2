...
sudo apt-get -y install build-essential cmake git ninja-build python3-minimal libpcap-dev
...
# FreeRTOS_Plus demos
make -j$(nproc) -C FreeRTOS-Plus/Demo/FreeRTOS_Plus_TCP_Echo_Posix
#make -j$(nproc) -C FreeRTOS-Plus/Demo/FreeRTOS_Plus_TCP_Echo_Qemu_mps2 # compile error
